(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@ngxs/store'),require('@angular/router'),require('@angular/common'),exports, require('@angular/core'), require('@ngxs/store'), require('@angular/router'), require('@angular/common'), require('@ngxs/store/internals'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@ngxs/router-plugin', ['@angular/core','@ngxs/store','@angular/router','@angular/common','exports', '@angular/core', '@ngxs/store', '@angular/router', '@angular/common', '@ngxs/store/internals', 'rxjs/operators'], factory) :
    (global = global || self, factory(global.ng.core,global.ngxs.store,global.ng.router,global.ng.common,(global.ngxs = global.ngxs || {}, global.ngxs['router-plugin'] = {}), global.ng.core, global['ngxs-store'], global.ng.router, global.ng.common, global['ngxs-store-internals'], global.rxjs.operators));
}(this, function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,exports, core, store, router, common, internals, operators) { 'use strict';
...
NgxsRouterPluginModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NgxsRouterPluginModule_Factory(t) { return new (t || NgxsRouterPluginModule)(); }, imports: [[store.NgxsModule.forFeature([RouterState])]] });
