(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('@ngxs/store'), require('@angular/common'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@ngxs/storage-plugin', ['@angular/core','exports', '@angular/core', '@ngxs/store', '@angular/common', 'rxjs/operators'], factory) :
    (global = global || self, factory(global.ng.core,(global.ngxs = global.ngxs || {}, global.ngxs['storage-plugin'] = {}), global.ng.core, global['ngxs-store'], global.ng.common, global.rxjs.operators));
}(this, function (ɵngcc0,exports, core, store, common, operators) { 'use strict';
...
NgxsStoragePlugin.ɵfac = function NgxsStoragePlugin_Factory(t) { return new (t || NgxsStoragePlugin)(ɵngcc0.ɵɵinject(NGXS_STORAGE_PLUGIN_OPTIONS), ɵngcc0.ɵɵinject(STORAGE_ENGINE), ɵngcc0.ɵɵinject(core.PLATFORM_ID)); };
